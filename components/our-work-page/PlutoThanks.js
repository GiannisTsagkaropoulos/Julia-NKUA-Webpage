function PlutoThanks() {
  return (
    <div>
      <h3 className="text-3xl lg:text-6xl  text-julia-blue-dark tracking-wider font-semibold text-center">
        A special thanks to{" "}
        <a
          target="_blank"
      ...
      <p className="text-xl lg:text-3xl  text-gray-700 tracking-wider font-semibold text-justify lg:text-center w-10/12 mx-auto">
      ...
      <h3 className="text-3xl lg:text-6xl tracking-wide text-gray-700 font-extrabold mx-auto text-center my-4 w-[60%]">
      ...
      <div className="text-lg lg:text-2xl tracking-wider font-medium w-[75%] mx-auto text-justify lg:text-center">
